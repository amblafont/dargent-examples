...
theory Ex1_dargentisa_AllRefine
imports "Ex1_dargentisa_NormalProof"
"Ex1_dargentisa_SCorres_Normal"
"Ex1_dargentisa_CorresProof"
"Ex1_dargentisa_MonoProof"
 ...
 *)
local_setup \<open>
let val typeproof_thy = "Ex1_dargentisa_TypeProof"
in
...
locale Ex1_dargentisa_cogent_shallow =
  "ex1_dargentisa" + correspondence +
...
sublocale Ex1_dargentisa_cogent_shallow \<subseteq> Ex1_dargentisa _ upd_abs_typing abs_repr
  by (unfold_locales)

sublocale Ex1_dargentisa_cogent_shallow \<subseteq> shallow val_abs_typing
  by (unfold_locales)

sublocale Ex1_dargentisa_cogent_shallow \<subseteq> correspondence_init
  by (unfold_locales)


context Ex1_dargentisa_cogent_shallow begin

(* Generate end-to-end refinement theorems, exported to corres_shallow_C_f *)
local_setup \<open>
filter (member op= Cogent_functions) entry_func_names
|> fold (fn f => fn lthy => let
     val thm = make_corres_shallow_C "Ex1_dargentisa_Shallow_Desugar" "Ex1_dargentisa_TypeProof" lthy f
