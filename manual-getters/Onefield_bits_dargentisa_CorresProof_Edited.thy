...
theory Onefield_bits_dargentisa_CorresProof_Edited
imports "Onefield_bits_dargentisa_CorresSetup_Edited"
...
val HO_call_hints =
     Cogent_functions
     |> Par_List.map (fn f => case CogentHigherOrder.make_HO_call_hints @{context} "onefield_bits_dargentisa.c" f of
