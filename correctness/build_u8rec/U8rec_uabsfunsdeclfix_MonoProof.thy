...
theory U8rec_uabsfunsdeclfix_MonoProof
...
where
  "rename__assocs \<equiv> [((''main'', Nil), ''main'')]"
...
local
  ...
  val rename_inverse =
    ...
    |> Symtab.make
  val poly_thy = "U8rec_uabsfunsdeclfix_Deep_Normal"
  val mono_thy = "U8rec_uabsfunsdeclfix_TypeProof"
