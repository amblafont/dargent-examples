...
theory Random_seed_AllRefine
imports "Random_seed_NormalProof"
"Random_seed_SCorres_Normal"
"Random_seed_CorresProof"
"Random_seed_MonoProof"
 ...
 *)
local_setup \<open>
let val typeproof_thy = "Random_seed_TypeProof"
in
...
sublocale Random_seed_cogent_shallow \<subseteq> shallow val_abs_typing
  by (unfold_locales)

sublocale Random_seed_cogent_shallow \<subseteq> correspondence_init
  by (unfold_locales)


context Random_seed_cogent_shallow begin

(* Generate end-to-end refinement theorems, exported to corres_shallow_C_f *)
local_setup \<open>
filter (member op= Cogent_functions) entry_func_names
|> fold (fn f => fn lthy => let
     val thm = make_corres_shallow_C "Random_seed_Shallow_Desugar" "Random_seed_TypeProof" lthy f
