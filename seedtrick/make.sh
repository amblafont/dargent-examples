...
echo cp $2.ac $AC_FILE
cp $2.ac $AC_FILE
echo s#$2.c#$2_$1.c# $AC_FILE
sed -i s#$2.c#$2_$1.c# $AC_FILE
# sed -i s#$2.c#$BUILD_DIR/$2_$1.c# $AC_FILE


echo $COGENT_PATH/cogent/.stack-work/dist/x86_64-linux-tinfo6/Cabal-2.4.0.1/build/cogent/cogent $2.cogent --infer-c-funcs=$AC_FILE  \
